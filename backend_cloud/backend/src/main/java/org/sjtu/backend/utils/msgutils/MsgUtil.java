package org.sjtu.backend.utils.msgutils;
...
public class MsgUtil {
    ...
    public static final int LOGIN_BAN_ERROR = -102;
    ...
    public static final String REGISTER_ERROR_MSG = "注册发生错误，请重试！";
    ...
    public static final String LOGIN_BAN_MSG = "您的账号已经被禁用！";
    public static final String REGISTER_NAME_MSG = "用户名重复！";
